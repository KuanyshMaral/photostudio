...
func (r *OwnerCRMRepository) GetProcurementItems(ctx context.Context, ownerID int64, showCompleted bool) ([]domain.ProcurementItem, error) {
	var items []domain.ProcurementItem
...
func (r *OwnerCRMRepository) CreateProcurementItem(ctx context.Context, item *domain.ProcurementItem) error {
...
func (r *OwnerCRMRepository) GetMaintenanceItems(ctx context.Context, ownerID int64, status string) ([]domain.MaintenanceItem, error) {
	var items []domain.MaintenanceItem
	query := r.db.WithContext(ctx).Where("owner_id = ?", ownerID)
...
func (r *OwnerCRMRepository) CreateMaintenanceItem(ctx context.Context, item *domain.MaintenanceItem) error {
	return r.db.WithContext(ctx).Create(item).Error
}
...
func (r *OwnerCRMRepository) GetCompanyProfile(ctx context.Context, ownerID int64) (*domain.CompanyProfile, error) {
	...
	if errors.Is(err, gorm.ErrRecordNotFound) {
		...
		profile = domain.CompanyProfile{OwnerID: ownerID}
...
func (r *OwnerCRMRepository) UpdateCompanyProfile(ctx context.Context, ownerID int64, updates *domain.CompanyProfile) error {
...
func (r *OwnerCRMRepository) GetPortfolio(ctx context.Context, ownerID int64) ([]domain.PortfolioProject, error) {
...
func (r *OwnerCRMRepository) AddPortfolioProject(ctx context.Context, project *domain.PortfolioProject) error {
...
func (r *OwnerCRMRepository) DeletePortfolioProject(ctx context.Context, ownerID, projectID int64) error {
	result := r.db.WithContext(ctx).
		...
		Delete(&domain.PortfolioProject{})
...
func (r *OwnerCRMRepository) ReorderPortfolio(ctx context.Context, ownerID int64, projectIDs []int64) error {
	return r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		for i, id := range projectIDs {
			if err := tx.Model(&domain.PortfolioProject{}).
