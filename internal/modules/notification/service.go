...
func (s *Service) Create(ctx context.Context, userID int64, t domain.NotificationType, title, message string, data map[string]any) error {
...
func (s *Service) GetUserNotifications(ctx context.Context, userID int64, limit int) ([]domain.Notification, int64, error) {
...
func (s *Service) NotifyVerificationApproved(ctx context.Context, ownerUserID, studioID int64) error {
	return s.Create(
		ctx,
		ownerUserID,
		domain.NotifVerificationApproved,
...
func (s *Service) NotifyVerificationRejected(ctx context.Context, ownerUserID, studioID int64, reason string) error {
	...
	return s.Create(
		ctx,
		ownerUserID,
		domain.NotifVerificationRejected,
