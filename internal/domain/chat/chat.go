...
type Conversation struct {
	...
	OtherUser *auth.User `json:"other_user,omitempty" gorm:"-"`

	// Информация о студии (если есть)
	Studio *catalog.Studio `json:"studio,omitempty" gorm:"-"`

	// Информация о бронировании (если есть)
	Booking *booking.Booking `json:"booking,omitempty" gorm:"-"`
...
type Message struct {
	...
	Sender *auth.User `json:"sender,omitempty" gorm:"-"`
}
