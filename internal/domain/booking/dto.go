...
type UpdatePaymentStatusRequest struct {
	PaymentStatus PaymentStatus `json:"payment_status" binding:"required,oneof=unpaid paid refunded"`
}
...
// ToBookingResponse конвертирует Booking в DTO
func ToBookingResponse(b *Booking, includeDeposit bool) BookingResponse {
